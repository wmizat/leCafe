...
header('Location: /managerlogin'); // Redirecting To Home Page
}
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="/myrestaurant" class="list-group-item active">My Restaurant</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="/myrestaurant1" method="POST">
        <br style="clear: both">
