      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"> <a href="/managerlogin">MANAGER CONTROL PANEL</a></li>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="/myrestaurant" class="list-group-item ">My Restaurant</a>
    		<a href="/view_food_items" class="list-group-item ">View Food Items</a>
    		<a href="/add_food_items" class="list-group-item ">Add Food Items</a>
    		<a href="/edit_food_items" class="list-group-item active">Edit Food Items</a>
    		<a href="/delete_food_items" class="list-group-item ">Delete Food Items</a>
        <a href="/view_order_details" class="list-group-item ">View Order Details</a>
    	</div>
    </div>
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    while ($row = mysqli_fetch_array($query)) {
      ...
      <div class="list-group" style="text-align: center;">
        <?php
      echo "<b><a href='/edit_food_items?update= {$row['F_ID']}'>{$row['name']}</a></b>";  
        ?>
      </div>
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="/edit_food_items" method="GET">
        <br style="clear: both">
